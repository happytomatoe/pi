...
type GoogleApiType = "google-generative-ai" | "google-ai-studio" | "google-vertex";
...
/**
 * Map Google's finish reason string to pi's StopReason.
 */
export function mapStopReasonString(reason: string): StopReason {
	switch (reason) {
		...
		case "SAFETY":
		case "RECITATION":
			return "stop"; // Map to stop for unknown reasons
		case "TOOL_USE":
			return "toolUse";
		default:
			return "stop";
